...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='tfrecord_tj',
  syntax='proto3',
  serialized_pb=_b('\n\rexample.proto\x12\x08tfrecord\"\x1a\n\tBytesList\x12\r\n\x05value\x18\x01 \x03(\x0c\"\x1e\n\tFloatList\x12\x11\n\x05value\x18\x01 \x03(\x02\x42\x02\x10\x01\"\x1e\n\tInt64List\x12\x11\n\x05value\x18\x01 \x03(\x03\x42\x02\x10\x01\"\x92\x01\n\x07\x46\x65\x61ture\x12)\n\nbytes_list\x18\x01 \x01(\x0b\x32\x13.tfrecord_tj.BytesListH\x00\x12)\n\nfloat_list\x18\x02 \x01(\x0b\x32\x13.tfrecord_tj.FloatListH\x00\x12)\n\nint64_list\x18\x03 \x01(\x0b\x32\x13.tfrecord_tj.Int64ListH\x00\x42\x06\n\x04kind\"\x7f\n\x08\x46\x65\x61tures\x12\x30\n\x07\x66\x65\x61ture\x18\x01 \x03(\x0b\x32\x1f.tfrecord_tj.Features.FeatureEntry\x1a\x41\n\x0c\x46\x65\x61tureEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12 \n\x05value\x18\x02 \x01(\x0b\x32\x11.tfrecord_tj.Feature:\x02\x38\x01\"1\n\x0b\x46\x65\x61tureList\x12\"\n\x07\x66\x65\x61ture\x18\x01 \x03(\x0b\x32\x11.tfrecord_tj.Feature\"\x98\x01\n\x0c\x46\x65\x61tureLists\x12=\n\x0c\x66\x65\x61ture_list\x18\x01 \x03(\x0b\x32\'.tfrecord_tj.FeatureLists.FeatureListEntry\x1aI\n\x10\x46\x65\x61tureListEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12$\n\x05value\x18\x02 \x01(\x0b\x32\x15.tfrecord_tj.FeatureList:\x02\x38\x01\"/\n\x07\x45xample\x12$\n\x08\x66\x65\x61tures\x18\x01 \x01(\x0b\x32\x12.tfrecord_tj.Features\"e\n\x0fSequenceExample\x12#\n\x07\x63ontext\x18\x01 \x01(\x0b\x32\x12.tfrecord_tj.Features\x12-\n\rfeature_lists\x18\x02 \x01(\x0b\x32\x16.tfrecord_tj.FeatureListsB\x03\xf8\x01\x01\x62\x06proto3')
)
...
_BYTESLIST = _descriptor.Descriptor(
  name='BytesList',
  full_name='tfrecord_tj.BytesList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tfrecord_tj.BytesList.value', index=0,
...
_FLOATLIST = _descriptor.Descriptor(
  name='FloatList',
  full_name='tfrecord_tj.FloatList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tfrecord_tj.FloatList.value', index=0,
...
_INT64LIST = _descriptor.Descriptor(
  name='Int64List',
  full_name='tfrecord_tj.Int64List',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='tfrecord_tj.Int64List.value', index=0,
...
_FEATURE = _descriptor.Descriptor(
  name='Feature',
  full_name='tfrecord_tj.Feature',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='bytes_list', full_name='tfrecord_tj.Feature.bytes_list', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='float_list', full_name='tfrecord_tj.Feature.float_list', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='int64_list', full_name='tfrecord_tj.Feature.int64_list', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='kind', full_name='tfrecord_tj.Feature.kind',
...
_FEATURES_FEATUREENTRY = _descriptor.Descriptor(
  name='FeatureEntry',
  full_name='tfrecord_tj.Features.FeatureEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='tfrecord_tj.Features.FeatureEntry.key', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='tfrecord_tj.Features.FeatureEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURES = _descriptor.Descriptor(
  name='Features',
  full_name='tfrecord_tj.Features',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feature', full_name='tfrecord_tj.Features.feature', index=0,
...
_FEATURELIST = _descriptor.Descriptor(
  name='FeatureList',
  full_name='tfrecord_tj.FeatureList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feature', full_name='tfrecord_tj.FeatureList.feature', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURELISTS_FEATURELISTENTRY = _descriptor.Descriptor(
  ...
  full_name='tfrecord_tj.FeatureLists.FeatureListEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='tfrecord_tj.FeatureLists.FeatureListEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='tfrecord_tj.FeatureLists.FeatureListEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_FEATURELISTS = _descriptor.Descriptor(
  name='FeatureLists',
  full_name='tfrecord_tj.FeatureLists',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='feature_list', full_name='tfrecord_tj.FeatureLists.feature_list', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_EXAMPLE = _descriptor.Descriptor(
  name='Example',
  full_name='tfrecord_tj.Example',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='features', full_name='tfrecord_tj.Example.features', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SEQUENCEEXAMPLE = _descriptor.Descriptor(
  ...
  full_name='tfrecord_tj.SequenceExample',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='context', full_name='tfrecord_tj.SequenceExample.context', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='feature_lists', full_name='tfrecord_tj.SequenceExample.feature_lists', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
BytesList = _reflection.GeneratedProtocolMessageType('BytesList', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:tfrecord_tj.BytesList)
  ))
...
FloatList = _reflection.GeneratedProtocolMessageType('FloatList', (_message.Message,), dict(
  ...
  __module__ = 'example_pb2'
  # @@protoc_insertion_point(class_scope:tfrecord_tj.FloatList)
  ))
...
Int64List = _reflection.GeneratedProtocolMessageType('Int64List', (_message.Message,), dict(
  ...
  __module__ = 'example_pb2'
  # @@protoc_insertion_point(class_scope:tfrecord_tj.Int64List)
  ))
...
Feature = _reflection.GeneratedProtocolMessageType('Feature', (_message.Message,), dict(
  DESCRIPTOR = _FEATURE,
  __module__ = 'example_pb2'
  # @@protoc_insertion_point(class_scope:tfrecord_tj.Feature)
  ))
...
Features = _reflection.GeneratedProtocolMessageType('Features', (_message.Message,), dict(
  ...
  FeatureEntry = _reflection.GeneratedProtocolMessageType('FeatureEntry', (_message.Message,), dict(
    ...
    __module__ = 'example_pb2'
    # @@protoc_insertion_point(class_scope:tfrecord_tj.Features.FeatureEntry)
    ))
  ,
  DESCRIPTOR = _FEATURES,
  __module__ = 'example_pb2'
  # @@protoc_insertion_point(class_scope:tfrecord_tj.Features)
  ))
...
FeatureList = _reflection.GeneratedProtocolMessageType('FeatureList', (_message.Message,), dict(
  ...
  __module__ = 'example_pb2'
  # @@protoc_insertion_point(class_scope:tfrecord_tj.FeatureList)
  ))
...
FeatureLists = _reflection.GeneratedProtocolMessageType('FeatureLists', (_message.Message,), dict(
  ...
  FeatureListEntry = _reflection.GeneratedProtocolMessageType('FeatureListEntry', (_message.Message,), dict(
    ...
    __module__ = 'example_pb2'
    # @@protoc_insertion_point(class_scope:tfrecord_tj.FeatureLists.FeatureListEntry)
    ))
  ,
  DESCRIPTOR = _FEATURELISTS,
  __module__ = 'example_pb2'
  # @@protoc_insertion_point(class_scope:tfrecord_tj.FeatureLists)
  ))
...
Example = _reflection.GeneratedProtocolMessageType('Example', (_message.Message,), dict(
  DESCRIPTOR = _EXAMPLE,
  __module__ = 'example_pb2'
  # @@protoc_insertion_point(class_scope:tfrecord_tj.Example)
  ))
...
SequenceExample = _reflection.GeneratedProtocolMessageType('SequenceExample', (_message.Message,), dict(
  ...
  __module__ = 'example_pb2'
  # @@protoc_insertion_point(class_scope:tfrecord_tj.SequenceExample)
  ))
